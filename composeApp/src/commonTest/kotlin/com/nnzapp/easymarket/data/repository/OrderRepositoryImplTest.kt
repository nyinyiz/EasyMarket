...
class OrderRepositoryImplTest {
    ...
    @Test
    fun `placeOrder returns success when api call succeeds`() = runBlocking {
        // Given
    ...
    @Test
    fun `placeOrder returns failure when api call throws exception`() = runBlocking {
        // Given
        val product = Product(name = "Test Product", price = 100, imageUrl = "test.jpg")
        val cartItem = CartItem(product = product, quantity = 2.0)
        val order = Order(items = listOf(cartItem), deliveryAddress = "123 Test St")
    ...
    @Test
    fun `placeOrder returns false when api returns false`() = runBlocking {
        // Given
        val product = Product(name = "Test Product", price = 100, imageUrl = "test.jpg")
    ...
    @Test
    fun `placeOrder converts domain order to dto correctly`() = runBlocking {
        // Given
