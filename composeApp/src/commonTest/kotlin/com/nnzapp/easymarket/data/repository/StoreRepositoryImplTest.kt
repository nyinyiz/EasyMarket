...
class StoreRepositoryImplTest {
    ...
    @Test
    fun `getStoreInfo returns success when api call succeeds`() =
        runBlocking {
            // Given
            val expectedStoreDto =
                StoreDto(
                    name = "Test Store",
                    rating = 4.5,
                    openingTime = "09:00",
    ...
    @Test
    fun `getStoreInfo returns failure when api call throws exception`() =
        runBlocking {
            // Given
    ...
    @Test
    fun `getStoreInfo maps dto to domain correctly`() =
        runBlocking {
            // Given
            val storeDto =
                StoreDto(
