...
class ProductRepositoryImplTest {
    ...
    fun `getProducts returns success when api call succeeds`() = runBlocking {
        // Given
        val expectedProductsDto = listOf(
    ...
    @Test
    fun `getProducts returns failure when api call throws exception`() = runBlocking {
        // Given
    ...
    @Test
    fun `getProducts returns empty list when api returns empty list`() = runBlocking {
        // Given
    ...
    @Test
    fun `getProducts maps dto to domain correctly`() = runBlocking {
        // Given
